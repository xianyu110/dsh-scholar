...
EVID=$(api -X POST "$BASE/v1/projects/$PROJ/evidence" -d "{\"source_type\":\"run\",\"run_ids\":[\"run_a_seed_11\",\"run_a_seed_23\",\"run_a_seed_47\"],\"artifact_refs\":[\"$ART\"],\"analysis_method\":\"bootstrap_95_mean_difference\",\"result\":{\"primary_metric\":\"mAP@0.5\",\"value\":61.2,\"baseline_value\":58.4,\"effect_size\":2.8,\"ci_low\":1.1,\"ci_high\":4.5,\"n_seeds\":3},\"provenance_status\":\"verified\"}" | jfield '.evidence_id')
