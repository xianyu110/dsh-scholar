...
/** Allowed transitions of the project state machine (design §5.1). */
export const TRANSITION_TABLE: Record<ProjectStatus, readonly ProjectStatus[]> = {
  DRAFT: ['SCOPED', 'FAILED', 'STOPPED'],
  SCOPED: ['SURVEYING', 'FAILED', 'STOPPED', 'BLOCKED_GATE'],
  SURVEYING: ['IDEATING', 'FAILED', 'STOPPED', 'BLOCKED_GATE'],
  IDEATING: ['IDEA_APPROVED', 'SURVEYING', 'FAILED', 'STOPPED', 'BLOCKED_GATE'],
  IDEA_APPROVED: ['BASELINE_REPRO', 'SURVEYING', 'FAILED', 'STOPPED', 'BLOCKED_GATE'],
  BASELINE_REPRO: ['CONTRACT_APPROVED', 'EXPERIMENTING', 'FAILED', 'STOPPED', 'BLOCKED_GATE'],
  CONTRACT_APPROVED: ['EXPERIMENTING', 'FAILED', 'STOPPED', 'BLOCKED_GATE'],
  EXPERIMENTING: ['EVIDENCE_READY', 'IDEA_APPROVED', 'FAILED', 'STOPPED', 'BLOCKED_GATE'],
  ...
  RELEASE_READY: ['ARCHIVED', 'RELEASED', 'FAILED', 'STOPPED', 'BLOCKED_GATE'],
  ARCHIVED: ['RELEASED', 'STOPPED'],
  RELEASED: ['STOPPED'],
  FAILED: ['STOPPED'],
  STOPPED: [],
  BLOCKED_GATE: ['SCOPED', 'SURVEYING', 'IDEATING', 'IDEA_APPROVED', 'BASELINE_REPRO', 'CONTRACT_APPROVED', 'EXPERIMENTING', 'EVIDENCE_READY', 'WRITING', 'REVIEWING', 'RELEASE_READY', 'FAILED', 'STOPPED'],
}
