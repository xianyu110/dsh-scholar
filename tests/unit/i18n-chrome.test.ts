...
const ALLOWED_HARDCODED: Record<string, string> = {
  ...
  'packages/dsh-research-ui/src/client/index.ts:882': 'stamp line: t(updatedAt) + Intl time + raw lastError (nested template)',
  ...
  'packages/dsh-research-ui/src/client/panels/phase.ts:107': 'raw budget numbers: used / max (nested template)',
  'packages/dsh-research-ui/src/client/panels/phase.ts:190': 'raw wire: baseline vs treatment methods · version (nested template)',
}
